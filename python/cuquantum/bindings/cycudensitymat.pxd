...
ctypedef enum cudensitymatBoundaryCondition_t "cudensitymatBoundaryCondition_t":
    CUDENSITYMAT_BOUNDARY_CONDITION_OPEN "CUDENSITYMAT_BOUNDARY_CONDITION_OPEN" = 0
...
ctypedef enum cudensitymatTimePropagationApproachKrylovConfigAttribute_t "cudensitymatTimePropagationApproachKrylovConfigAttribute_t":
    ...
    CUDENSITYMAT_PROPAGATION_APPROACH_KRYLOV_MAX_DIM "CUDENSITYMAT_PROPAGATION_APPROACH_KRYLOV_MAX_DIM" = 1
